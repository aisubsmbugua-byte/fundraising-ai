  ...
  return (
    <div style={{ maxWidth: 480 }}>
      ...
      <p style={{ color: colors.textMuted, fontSize: 14 }}>
        Pick a channel and AI searches the web for a candidate funder matching your Organization
        Profile — 1 per run while we confirm reliability, scoped up again once this holds up. Each
        candidate is cross-referenced against public IRS filing data
